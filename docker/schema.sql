...
CREATE TABLE IF NOT EXISTS `db`.`question` (
                                               ...
                                               `id_teaching_lang` INT NOT NULL,
                                               PRIMARY KEY (`id_question`, `id_teaching_lang`),
                                               INDEX `fk_question_teaching_lang1_idx` (`id_teaching_lang` ASC) VISIBLE,
                                               CONSTRAINT `fk_question_teaching_lang1`
                                                   FOREIGN KEY (`id_teaching_lang`)
                                                       REFERENCES `db`.`teaching_lang` (`id_teaching_lang`)
                                                       ON DELETE NO ACTION
                                                       ON UPDATE NO ACTION)
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`user` (`id_user`, `name`, `surname`, `email`, `hashed_password`, `role`, `username`, `icon`) VALUES (1, 'Martin', 'Kvapil', 'm@gmail.com', '$2a$10$WceZ.eP/EXu9yRKDXjNscutDA39U30BtJ.Rre4nDrKT8u6MfaICHS\n', 'admin', 'admin', NULL);
...
INSERT INTO `db`.`course` (`id_course`, `points`, `native_lang`, `description`, `id_teaching_lang`, `id_user`) VALUES (2, 0, 'cz', 'course of german', 2, 2);
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`question` (`id_question`, `question`, `answ1`, `answ2`, `answ3`, `answ4`, `points`, `id_teaching_lang`) VALUES (1, 'car', 'auto', 'kolo', 'letadlo', NULL, NULL, DEFAULT);
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`test` (`id_test`, `question_count`, `test_name`) VALUES (1, 10, 'Náhodný 1');
INSERT INTO `db`.`test` (`id_test`, `question_count`, `test_name`) VALUES (2, 15, 'Náhodný 2');
INSERT INTO `db`.`test` (`id_test`, `question_count`, `test_name`) VALUES (3, 10, 'Náhodný 3');
INSERT INTO `db`.`test` (`id_test`, `question_count`, `test_name`) VALUES (4, 10, 'Náhodný 4');
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`test_to_question` (`id_test_to_question`, `id_test`, `id_question`, `answ`) VALUES (1, 1, 1, NULL);
...
INSERT INTO `db`.`course_to_test` (`id_course_to_test`, `id_course`, `id_test`) VALUES (2, 1, 2);
INSERT INTO `db`.`course_to_test` (`id_course_to_test`, `id_course`, `id_test`) VALUES (3, 1, 3);
