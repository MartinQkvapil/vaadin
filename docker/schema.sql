...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`test` (`id_test`, `question_count`) VALUES (1, 10);
INSERT INTO `db`.`test` (`id_test`, `question_count`) VALUES (2, 15);
INSERT INTO `db`.`test` (`id_test`, `question_count`) VALUES (3, 10);
INSERT INTO `db`.`test` (`id_test`, `question_count`) VALUES (4, 10);
